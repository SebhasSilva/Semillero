...
from .views import register, login_view, logout_view, profile, delete_photo, CustomPasswordResetView, CustomPasswordResetDoneView, CustomPasswordResetConfirmView, CustomPasswordResetCompleteView
...
urlpatterns = [
    ...
    path('delete_photo/<int:photo_id>/', delete_photo, name='delete_photo'),  # URL para eliminar una foto
